...
const gitlink = document.getElementById('github');
    ...
    mostrarimg(img);
     ...
     projetolink.href = 'https://github.com/matias-gui/projeto-login';
     projetolink.target = '_blank';
     gitlink.href = 'https://matias-gui.github.io/projeto-login';
    ...
    function atualizarLinks(imgn) {
     ...
     if(imgn === 0){
            ...
            projetolink.href = 'https://github.com/matias-gui/site-android';
            projetolink.target = '_blank';
            gitlink.href = 'https://matias-gui.github.io/site-android/';
            gitlink.target = '_blank';
        } else if(imgn === 2){
            projetolink.href = 'https://github.com/matias-gui/projeto-cordel-moderno';
            projetolink.target = '_blank';
            gitlink.href = 'https://matias-gui.github.io/projeto-cordel-moderno/';
            gitlink.target = '_blank';
        }else if(imgn === 3){
            projetolink.href = 'https://github.com/matias-gui/projeto-redes-sociais';
            projetolink.target = '_blank';
            gitlink.href = 'https://matias-gui.github.io/projeto-redes-sociais/';
            gitlink.target = '_blank';
        }
    }
